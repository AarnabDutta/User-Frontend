                ...
                <div className="max-w-7xl mx-auto relative w-full">
                    ...
                    >
                        ...
                        <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                            FILxCONNECT empowers teams to work together seamlessly, bringing your projects to life with powerful collaboration tools.
                        </p>
                                ...
                                {activeTab === 1 && (
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">
                                                Experience blazing-fast load times and real-time updates.
                                                Our optimized infrastructure ensures smooth operation at any scale.
                                            </p>
                                        </div>
                                    </div>
                                )}
                                {activeTab === 2 && (
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">
                                                Count on us to keep your team connected. Our reliable platform
                                                ensures your work never stops with industry-leading uptime.
                                            </p>
                                        </div>
                                    </div>
                                )}
